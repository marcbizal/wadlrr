...
module.exports = {
   ...
   * @param {string} filename - the filename of the wad (actual or artificial)
  ...
  load(wadPath) {
    return fsp.readFile(wadPath).then(data => this.parse(
      path.basename(wadPath),
      data,
    ));
  },
};
